 ...
 *
 * Este archivo es el viejo Admin.jsx renombrado: cuando agregamos el ABM de
 * géneros, /admin pasó a ser una página "hub" (Admin.jsx) desde la que se
 * elige "Libros" o "Géneros". La tabla de libros que antes vivía directo en
 * /admin ahora vive en /admin/libros, para dejar lugar a /admin/generos.
 *
    ...
    return (
        <div className="container py-5">
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
                <h2 className="serif mb-0">Libros</h2>
