...
export async function obtenerTodos() {
    try {
        ...
        // $ne: "not equal" — trae todos los docs donde borrado NO sea true
        // toArray() convierte el cursor de MongoDB en un array de documentos
...
export async function actualizar(id, campos) {
    try {
        await client.connect();
        // Excluimos _id del $set — MongoDB no permite modificar el _id de un documento
        const { _id, ...camposSinId } = campos;
        // Filtramos undefined: el driver v7 los convierte en null en la BD si no se filtran
...
/**
 * Soft delete: marca el género como borrado sin eliminarlo físicamente.
 *
